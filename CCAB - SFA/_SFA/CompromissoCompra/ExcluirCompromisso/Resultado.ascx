<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Resultado.ascx.cs" Inherits="_SFA_CompromissoCompra_ExcluirCompromisso_Resultado" %>
...
<div style="text-align: right; margin-top: 15px;">
    ...
    <asp:Button runat="server" ID="btAction" CssClass="button" ValidationGroup="Form"
        Text="Excluir" CausesValidation="true" 
