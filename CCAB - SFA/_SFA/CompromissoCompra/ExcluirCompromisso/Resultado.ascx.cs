...
public partial class _SFA_CompromissoCompra_ExcluirCompromisso_Resultado : System.Web.UI.UserControl
{
    ...
    public void BindGridView()
    {
        ...
        DataTable dt = obj.ObterListaCompromissoCompraExclusao(_agente,
                                                               _safra,
                                                               _moeda,
                                                               _compromisso,
                                                               _origem);
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            CompromissoCompra obj = new CompromissoCompra();
            msg = obj.ExcluiCompromissoCompra(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
