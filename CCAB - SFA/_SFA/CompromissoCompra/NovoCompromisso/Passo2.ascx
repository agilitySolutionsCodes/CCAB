<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Passo2.ascx.cs" Inherits="_SFA_CompromissoCompra_NovoCompromisso_Passo2" %>
...
<script type="text/javascript">
    ...
    function FpSpread1_Blur(event) {
        ...
        if (sDecimalPlaces == 0) {
            ...
            //spread.SetValue(spread.ActiveRow, spread.ActiveCol, sAux + "," + sDec, true);
        }
        chkQuant();
    }
</script>