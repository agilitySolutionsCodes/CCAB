<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AlterarCompromisso.aspx.cs" Inherits="_SFA_CompromissoCompra_AlterarCompromisso" %>
<%@ Register TagPrefix="uc" TagName="Passo1" Src="~/_SFA/CompromissoCompra/AlterarCompromisso/Passo1.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo2Header" Src="~/_SFA/CompromissoCompra/AlterarCompromisso/Passo2Header.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo2" Src="~/_SFA/CompromissoCompra/AlterarCompromisso/Passo2.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo3Header" Src="~/_SFA/CompromissoCompra/AlterarCompromisso/Passo3Header.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo3" Src="~/_SFA/CompromissoCompra/AlterarCompromisso/Passo3.ascx" %>
            ...
            <asp:View ID="View4" runat="server">
                ...
                <div class="tbCadastro_Mestra">
                    <h2 style="color: #808080">
                        Compromisso de Compra Nº <%= numCompromisso %> alterado com sucesso.
                        
                      
                    </h2>
                    <br /><br />
                    <asp:Button runat="server" ID="btAlterarCompromisso" CssClass="button" Text="compromissos" 
                        CausesValidation="false" OnCommand="btAlterarCompromisso_OnClick" Width="140" />&nbsp;&nbsp;
