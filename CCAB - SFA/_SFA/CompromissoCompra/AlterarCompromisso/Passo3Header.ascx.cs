...
public partial class _SFA_CompromissoCompra_AlterarCompromisso_Passo3Header : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (tb.Rows.Count > 0)
        {
            ...
            try
            {
                ...
                sb.Append("<span style='float: left; width: " + tituloWidth + "'>Nº Compromisso:</span>" +
                          "<span style='float: right; width: " + contentWidth + "'>" +
                          r["cdCompromissoCompraSEQ"].ToString() + "</span>");
            ...
            catch { Response.Redirect("~/_SFA/CompromissoCompra/AlterarCompromisso/AlterarCompromisso.aspx"); }
