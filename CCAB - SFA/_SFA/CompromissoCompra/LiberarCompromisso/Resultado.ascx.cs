...
public partial class _SFA_CompromissoCompra_LiberarCompromisso_Resultado : System.Web.UI.UserControl
{
    ...
    public void BindGridView()
    {
        ...
        long _compromisso = _value == "" ? 0 : Convert.ToInt64(_value);

        CompromissoCompra obj = new CompromissoCompra();
        DataTable dt = obj.ObterListaCompromissoCompraLiberacao(_agente,
                                                                _safra,
                                                                _moeda,
                                                                _compromisso,
                                                                _origem);
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            CompromissoCompra obj = new CompromissoCompra();
            msg = obj.LiberaCompromissoCompra(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
            msg = "Nenhum Compromisso foi Selecionado";
