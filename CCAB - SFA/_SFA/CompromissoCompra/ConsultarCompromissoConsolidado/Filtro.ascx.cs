...
public partial class _SFA_CompromissoCompra_ConsultarCompromissoConsolidado_Filtro : System.Web.UI.UserControl
{
    ...
    protected void btPesquisar_OnClick(object sender, EventArgs e)
    {
        ...
        bt.Attributes.Add("onclick", string.Format("javascript:ExibirRelatorioCompromissoCompraConsolidado('{0}','{1}'); return false;", _agente, _safra));
        ...
        btCompromissoCompraAnaliticoSimples.Attributes.Add("onclick", string.Format("javascript:ExibirRelatorioCompromissoCompraConsolidado('{0}','{1}'); return false;", _agente, _safra));
