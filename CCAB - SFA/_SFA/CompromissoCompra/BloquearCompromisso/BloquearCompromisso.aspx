<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BloquearCompromisso.aspx.cs" Inherits="_SFA_BloquearCompromisso_BloquearCompromisso" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/CompromissoCompra/BloquearCompromisso/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/CompromissoCompra/BloquearCompromisso/Resultado.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tbCadastro_Mestra">
        <h2 style="color: #808080">
            Compromisso(s) Bloqueado(s) com sucesso.<br />
        </h2>
        <br />
        <asp:Button runat="server" ID="btLiberarPedido" CssClass="button" Text="bloquear compromisso" 
