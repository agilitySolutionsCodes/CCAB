<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Filtro.ascx.cs" Inherits="_SFA_BloquearCompromisso_BloquearCompromisso_Filtro" %>
        ...
        <tr>
            ...
            <td class="tbTd_CinzaClara">
                ...
                <asp:DropDownList ID="cdPessoaOrigemFaturamento" runat="server" AutoPostBack="true"    
                    ...
                    DataTextField="dsPessoaOrigemFaturamento" DataSourceID="ObjectDataSource4" />
            </td>
        </tr>
        <tr>
            <td class="tbTd_cinzaEscura" nowrap>
