<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Resultado.ascx.cs" Inherits="_SFA_CompromissoCompra_BloquearCompromisso_Resultado" %>
...
<script type="text/javascript">
    ...
    function Confirmacao() {
        ...
        if (_valor <= 0) {
            ...
            return confirm("Deseja realmente bloquear\no(s) registro(s) selecionado(s)?");
    }
</script>
...
<div style="text-align: right; margin-top: 15px;">
    ...
    <asp:Button runat="server" ID="btAction" CssClass="button" ValidationGroup="Form"
        Text="Bloquear" CausesValidation="true" 
