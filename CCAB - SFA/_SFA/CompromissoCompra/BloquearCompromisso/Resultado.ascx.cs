...
public partial class _SFA_CompromissoCompra_BloquearCompromisso_Resultado : System.Web.UI.UserControl
{
    ...
    public void BindGridView()
    {
        ...
        DataTable dt = obj.ObterListaCompromissoCompraBloqueio(_agente,
                                                               _safra,
                                                               _moeda,
                                                               _pedido,
                                                               _origem);
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            CompromissoCompra obj = new CompromissoCompra();
            msg = obj.BloquearCompromissoCompra(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
