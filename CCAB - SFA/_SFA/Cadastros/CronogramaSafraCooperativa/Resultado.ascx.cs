...
public partial class _SFA_CronogramaSafraCooperativa_Resultado : System.Web.UI.UserControl
{
    ...
    {
        BindGridView();
        GridView1.SelectedIndex = Convert.ToInt16(Session["CronogramaSafraCooperativaGridViewIndex"]);
        //Session["CronogramaSafraCooperativaGridViewSelected"] = GridView1.SelectedDataKey.Value.ToString();
    }
}
