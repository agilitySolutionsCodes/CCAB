...
public partial class _SFA_CronogramaSafraCooperativa_Formulario : System.Web.UI.UserControl
{
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        Conv.ReflectObject<CronogramaSafraCooperativa> ro = new Conv.ReflectObject<CronogramaSafraCooperativa>();
    ...
    private bool Existe()
    {
        ...
        {
            lblMensagen.Text = "Já existe uma cooperativa cadastrada para esta safra!";
