<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Formulario.ascx.cs" Inherits="_SFA_CronogramaSafraCooperativa_Formulario" %>
...
<!-- Formulário -->
<div>          
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="cdCronogramaSafraCooperativaSEQ" CellPadding="5"
        ...
        <EditItemTemplate>
            <div class="pageSection">
                ...
                <asp:HiddenField ID="cdCronogramaSafraCooperativaSEQ" runat="server" Value='<%# Bind("cdCronogramaSafraCooperativaSEQ") %>' />                  
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbCadastro_Mestra">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:HiddenField ID="hiddenFieldcdCooperativaSEQ" runat="server" Value='<%# Bind("cdPessoaSEQ") %>' />
                    ...
                    <tr>                                                
                        ...
                        <td>
                            <asp:HiddenField ID="hiddenFieldCronogramaSafraCooperativa" runat="server" Value='<%# Bind("cdIndicadorSituacaoCooperativa") %>' />
                            <asp:DropDownList ID="cdIndicadorSituacaoCooperativa" Width="155" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="DataSourceSimNao" />        
                        </td>
                    </tr>                    
                    <tr>
                        <td valign="middle" class="fonteTbCadastro">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="wkCronogramaSafraCooperativa" TextMode="MultiLine" runat="server" Width="650" Rows="3" Text='<%# Bind("wkCronogramaSafraCooperativa") %>'></asp:TextBox>
                        </td>                      
                    </tr>                    
                </table>
            </div>            
