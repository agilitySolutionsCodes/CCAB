<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Formulario.ascx.cs" Inherits="_SFA_Vendedor_Formulario" %>
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="cdPessoaSEQ" CellPadding="5"
        ...
        <EditItemTemplate>
            <div class="pageSection">
                ...
                <asp:TabContainer ID="TabContainer1" Height="250" runat="server">
                        ...
                        <ContentTemplate>
                            <table width="100%" border="0" cellpadding="3" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="tdCamposFormularios">
                                        <conv:TextBox Type="Text" Enabled="false" ID="dtNascimentoPessoa" runat="server" 
                                            Columns="10" CssClass="campoTexto" Text='<%# Bind("dtNascimentoPessoa", "{0:dd/MM/yyyy}") %>' />
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdCamposFormularios">
                                        <asp:DropDownList Enabled="false" ID="cdIndicadorTipoAgenteComercialPessoa" runat="server"   
                                            CssClass="campoTexto" OnPreRender="ConfigCombo" DataValueField="vrDominioCodigoReferenciado"   
                                            DataTextField="wkDominioCodigoReferenciado" DataSourceID="ObjectDataSource11" />
                                    </td>
                                    <td>
                                    </td>
                                </tr>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource11" runat="server" SelectMethod="ObterLista" TypeName="CodigoReferenciado">
                <SelectParameters>
