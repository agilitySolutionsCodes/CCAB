...
public partial class _SFA_Vendedor_Formulario : System.Web.UI.UserControl
{
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        string _dsEmailPessoa = t.Text;

        Pessoa obj = new Pessoa();
        string msg = obj.AlterarVendedor(_cdPessoaSEQ, _cdIndicadorTipoAcessoPessoa,
                                         _dsLoginPessoa, _cdIndicadorPrimeiroAcessoPessoa,
                                         _cdIndicadorSenhaBloqueadaPessoa,
                                         _cdGrupoAcessoSEQ, _cdUsuarioUltimaAlteracao, _dsEmailPessoa);
