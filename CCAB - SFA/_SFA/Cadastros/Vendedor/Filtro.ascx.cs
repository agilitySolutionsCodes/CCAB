...
public partial class _SFA_Vendedor_Filtro : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cdIndicadorTipoAgenteComercialPessoa.DataBind();
        cdIndicadorTipoAgenteComercialPessoa.Items.Insert(0, new ListItem("", "0"));
        _value = cdIndicadorTipoAgenteComercialPessoaValue.Value;
        cdIndicadorTipoAgenteComercialPessoa.SelectedValue = _value == "" ? "0" : _value;

        if (!IsPostBack)
        {
            lib.VerificarAcessoBotao("AgenteComercial", btPesquisar);
            cdPessoaERP.Focus();
        }
        else
        {
