...
public partial class _SFA_PrincipioAtivo_PrincipioAtivo : System.Web.UI.Page
{
    internal string _nometela = "Cronograma da Safra - Princípio Ativo";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lib.VerificarAcessoBotao("RegraPrincipioAtivo", btIncluir);
            lib.VerificarAcessoBotao("RegraPrincipioAtivo", btEdit);
            lib.VerificarAcessoBotao("RegraPrincipioAtivo", btView);
            lib.VerificarAcessoBotao("RegraPrincipioAtivo", btDelete);
            ...
            case "View":
                {
                    ...
                    SetValueDropDown("cdTipoProduto", "hiddenFieldTipoProduto");
            ...
            case "Edit":
                {
                    ...
                    DisableControls("cdFornecedorPrincipioAtivo", "disable");
                    DisableControls("cdCooperativaSEQ", "disable");  

                    SetValueDropDown("cdCooperativaSEQ", "hiddenFieldcdCooperativaSEQ");
                    SetValueDropDown("cdTipoProduto", "hiddenFieldTipoProduto");
                    //SetValueDropDown("cdFornecedorPrincipioAtivo", "hiddenFieldcdFornecedorPrincipioAtivo");
                    //SetValueDropDown("cdIndicadorPrincipioAtivo", "hiddenFieldcdIndicadorPrincipioAtivo");
                    //SetValueDropDown("cdIndicadorProdutoAcabado", "hiddenFieldcdIndicadorProdutoAcabado");                    
