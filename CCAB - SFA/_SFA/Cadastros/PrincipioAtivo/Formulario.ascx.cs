...
public partial class _SFA_PrincipioAtivo_Formulario : System.Web.UI.UserControl
{
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        Conv.ReflectObject<CronogramaSafraPrincipioAtivo> ro = new Conv.ReflectObject<CronogramaSafraPrincipioAtivo>();
    ...
    private bool ValidaSafraExistente()
    {
        ...
        if (Obj.ExistePrecoProduto(Convert.ToInt32(Session["cdCronogramaSafraSEQ"]), Convert.ToInt64(Session["cdCooperativaSEQ"])))
        {
            lblMensagen.Text = "Existe uma tabela de preços cadastrada para essa Safra, Operação não permitida!";
            lblMensagen.Visible = true;
            ModalPopupExtender1.Show();
            return false;
        }
