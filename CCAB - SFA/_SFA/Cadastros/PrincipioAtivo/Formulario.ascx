<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Formulario.ascx.cs" Inherits="_SFA_PrincipioAtivo_Formulario" %>
...
<!-- Formulário -->
<div>          
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="cdCooperativaPrincipioAtivoSEQ" CellPadding="5"
        ...
        <EditItemTemplate>
            <div class="pageSection">
                ...
                <asp:HiddenField ID="cdCooperativaPrincipioAtivoSEQ" runat="server" Value='<%# Bind("cdCooperativaPrincipioAtivoSEQ") %>' />                  
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbCadastro_Mestra">
                    ...
                    <tr>
                        ...
                        <td  style="display:none">
                            <asp:HiddenField ID="hiddenFieldcdFornecedorPrincipioAtivo" runat="server" Value='<%# Bind("cdFornecedorPrincipioAtivo") %>' />
                            <asp:DropDownList ID="cdFornecedorPrincipioAtivo" Width="470" runat="server"  CssClass="campoTexto" DataValueField="cdPessoaOrigemFaturamento" DataTextField="dsPessoaOrigemFaturamento" DataSourceID="dataSourceFornecedor" />              
                        </td>                           
                        <td valign="middle" class="fonteTbCadastro">
                            Tipo:
                        </td>    
                        <td>
                            <asp:HiddenField ID="hiddenFieldTipoProduto" runat="server" Value='<%# Bind("cdTipoProduto") %>' />
                            <asp:DropDownList ID="cdTipoProduto" Width="155" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="dataSourceTipoProduto" />        
                        </td>
                    </tr>                    
                    <tr>
                        <td valign="middle" class="fonteTbCadastro">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="wkCooperativaPrincipioAtivo" TextMode="MultiLine" runat="server" Width="650" Rows="3" Text='<%# Bind("wkCooperativaPrincipioAtivo") %>'></asp:TextBox>
                        </td>                      
                    </tr>                    
                </table>
            </div>            
