<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GrupoAcesso.aspx.cs" Inherits="_SFA_GrupoAcesso_GrupoAcesso" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/Cadastros/GrupoAcesso/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/Cadastros/GrupoAcesso/Resultado.ascx" %>
<%@ Register TagPrefix="uc" TagName="Formulario" Src="~/_SFA/Cadastros/GrupoAcesso/Formulario.ascx" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="500" align="left">
                                        ...
                                        <asp:ImageButton ID="btPermissao" ImageAlign="AbsMiddle" BackColor="Transparent" 
                                            ImageUrl="~/imgsCCAB/tbTitulo_btHistorico.gif" OnClick="btPermissao_OnClick" AlternateText=".: Permissões" runat="server" />
                                    </td>
