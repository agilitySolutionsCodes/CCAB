<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Colaborador.aspx.cs" Inherits="_SFA_Colaborador_Colaborador" %>
<%@ Register TagPrefix="uc" TagName="DadosPai" Src="~/_SFA/Cadastros/Colaborador/DadosPai.ascx" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/Cadastros/Colaborador/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/Cadastros/Colaborador/Resultado.ascx" %>
<%@ Register TagPrefix="uc" TagName="Formulario" Src="~/_SFA/Cadastros/Colaborador/Formulario.ascx" %>
