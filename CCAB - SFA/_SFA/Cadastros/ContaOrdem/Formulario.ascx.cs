...
public partial class _SFA_ContaOrdem_Formulario : System.Web.UI.UserControl
{
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        Conv.ReflectObject<CronogramaSafraContaOrdem> ro = new Conv.ReflectObject<CronogramaSafraContaOrdem>();
    ...
    private bool Existe()
    {
        ...
        {
            lblMensagen.Text = "Já existe uma conta e ordem cadastrada para esta safra!";
