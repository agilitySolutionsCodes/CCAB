...
public partial class _SFA_ContaOrdem_ContaOrdem : System.Web.UI.Page
{
    internal string _nometela = "Cronograma da Safra - Conta Ordem";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lib.VerificarAcessoBotao("RegraContaOrdem", btIncluir);
            lib.VerificarAcessoBotao("RegraContaOrdem", btEdit);
            lib.VerificarAcessoBotao("RegraContaOrdem", btView);
            lib.VerificarAcessoBotao("RegraContaOrdem", btDelete);
            ...
            case "View":
                {
                    ...
                    SetValueDropDown("cdIndicadorContaOrdem", "hiddenFieldContaOrdem"); 
