<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Formulario.ascx.cs" Inherits="_SFA_ContaOrdem_Formulario" %>
...
<!-- Formulário -->
<div>          
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="cdCooperativaContaOrdemSEQ" CellPadding="5"
        ...
        <EditItemTemplate>
            <div class="pageSection">
                ...
                <asp:HiddenField ID="cdCooperativaContaOrdemSEQ" runat="server" Value='<%# Bind("cdCooperativaContaOrdemSEQ") %>' />                  
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbCadastro_Mestra">
                    ...
                    <tr>                                                
                        ...
                        <td>
                            <asp:HiddenField ID="hiddenFieldContaOrdem" runat="server" Value='<%# Bind("cdIndicadorContaOrdem") %>' />
                            <asp:DropDownList ID="cdIndicadorContaOrdem" Width="155" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="DataSourceSimNao" />        
                        </td>
                    </tr>                    
                    <tr>
                        <td valign="middle" class="fonteTbCadastro">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="wkCooperativaContaOrdem" TextMode="MultiLine" runat="server" Width="650" Rows="3" Text='<%# Bind("wkCooperativaContaOrdem") %>'></asp:TextBox>
                        </td>                      
                    </tr>                    
                </table>
            </div>            
