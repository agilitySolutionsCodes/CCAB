...
public partial class _SFA_CessaoCredito_Formulario : System.Web.UI.UserControl
{
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        Conv.ReflectObject<CronogramaSafraCessaoCredito> ro = new Conv.ReflectObject<CronogramaSafraCessaoCredito>();
    ...
    private bool Existe()
    {
        ...
        {
            lblMensagen.Text = "Já existe uma cessão de crédito cadastrada para esta safra!";
