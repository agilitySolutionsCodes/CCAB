...
public partial class _SFA_CessaoCredito_CessaoCredito : System.Web.UI.Page
{
    internal string _nometela = "Cronograma da Safra - Cessão de Crédito";
    ...
    internal string ControlFocusOnInsert = "dtCronogramaSafraCessaoCredito";
    // Update
    internal string DisableOnUpdateForm = "";
    internal string VanishOnUpdateForm = "";
    internal string ControlFocusOnUpdate = "dtCronogramaSafraCessaoCredito";
    // Delete
    internal string ControlToShowInDeleteMessage = "dsCessaoCredito";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Session["CessaoCreditoGridViewSelected"] = "0";
            ...
            lib.VerificarAcessoBotao("RegraCessaoCredito", btIncluir);
            lib.VerificarAcessoBotao("RegraCessaoCredito", btEdit);
            lib.VerificarAcessoBotao("RegraCessaoCredito", btView);
            lib.VerificarAcessoBotao("RegraCessaoCredito", btDelete);

            //lib.VerificarAcessoBotao("CessaoCreditoHistorico", btHistorico);
        }
            ...
            case "View":
                {
                    ...
                    SetValueDropDown("cdIndicadorCessaoCredito", "hiddenFieldCessaoCredito"); 

                    SetValueDropDown("cdIndicadorPedidoNormal", "hiddenFieldPedidoNormal"); 
                    SetValueDropDown("cdIndicadorPedidoContaOrdem", "hiddenFieldPedidoContaOrdem"); 
    ...
    protected void btHistorico_OnClick(object sender, EventArgs e)
    {
        ...
        {
            PrepareCall();
            Response.Redirect("~/_SFA/Cadastros/CessaoCreditoHistorico/CessaoCreditoHistorico.aspx");
        }
    }
    ...
    protected void PrepareCall()
    {
        ...
        Session["cdCessaoCreditoSEQ"] = Session["CessaoCreditoGridViewSelected"];
        Session["dsCessaoCreditoHistorico"] = gv.SelectedRow.Cells[2].Text;
    }
