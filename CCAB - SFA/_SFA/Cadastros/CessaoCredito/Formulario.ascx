<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Formulario.ascx.cs" Inherits="_SFA_CessaoCredito_Formulario" %>
...
<!-- Formulário -->
<div>          
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="cdCooperativaCessaoCreditoSEQ" CellPadding="5"
        ...
        <EditItemTemplate>
            <div class="pageSection">
                ...
                <asp:HiddenField ID="cdCooperativaCessaoCreditoSEQ" runat="server" Value='<%# Bind("cdCooperativaCessaoCreditoSEQ") %>' />                  
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbCadastro_Mestra">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:DropDownList  ID="cdCooperativaSEQ" runat="server"  CssClass="campoTexto" DataValueField="cdPessoaSEQ" Width="519" DataTextField="nmPessoa" DataSourceID="dataSourceAgente" />
                        </td>                
                    </tr>
                    ...
                    <tr>                                                
                        ...
                        <td>
                            <asp:HiddenField ID="hiddenFieldPedidoNormal" runat="server" Value='<%# Bind("cdIndicadorPedidoNormal") %>' />
                            <asp:DropDownList ID="cdIndicadorPedidoNormal" Width="80" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="DataSourceSimNao" />        
                        </td>
                        ...
                        <td>
                            <asp:HiddenField ID="hiddenFieldPedidoContaOrdem" runat="server" Value='<%# Bind("cdIndicadorPedidoContaOrdem") %>' />
                            <asp:DropDownList ID="cdIndicadorPedidoContaOrdem" Width="80" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="DataSourceSimNao" />        
                        </td>
                    ...
                    <tr>                                                
                        ...
                        <td>
                            <asp:HiddenField ID="hiddenFieldCessaoCredito" runat="server" Value='<%# Bind("cdIndicadorCessaoCredito") %>' />
                            <asp:DropDownList ID="cdIndicadorCessaoCredito" Width="80" runat="server" CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" DataTextField="wkDominioCodigoReferenciado" DataSourceID="DataSourceSimNao" />        
                        </td>
                    </tr>                    
                    <tr>
                        <td valign="middle" class="fonteTbCadastro">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="wkCooperativaCessaoCredito" TextMode="MultiLine" runat="server" Width="650" Rows="3" Text='<%# Bind("wkCooperativaCessaoCredito") %>'></asp:TextBox>
                        </td>                      
                    </tr>                    
                </table>
            </div>            
