...
public partial class _SFA_CessaoCredito_Resultado : System.Web.UI.UserControl
{
    ...
    {
        BindGridView();
        GridView1.SelectedIndex = Convert.ToInt16(Session["CessaoCreditoGridViewIndex"]);
        //Session["CessaoCreditoGridViewSelected"] = GridView1.SelectedDataKey.Value.ToString();
    }
}
