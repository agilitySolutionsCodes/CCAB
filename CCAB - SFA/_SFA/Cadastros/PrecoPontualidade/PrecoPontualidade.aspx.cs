...
public partial class _SFA_PrecoPontualidade_PrecoPontualidade : System.Web.UI.Page
{
    internal string _nometela = "Cronograma da Safra - Vencimentos - Preço / Pontualidade";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lib.VerificarAcessoBotao("RegraPrecoPontualidade", btIncluir);
            lib.VerificarAcessoBotao("RegraPrecoPontualidade", btEdit);
            lib.VerificarAcessoBotao("RegraPrecoPontualidade", btView);
            lib.VerificarAcessoBotao("RegraPrecoPontualidade", btDelete);
