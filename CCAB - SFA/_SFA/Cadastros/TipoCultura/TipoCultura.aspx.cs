...
public partial class _SFA_TipoCultura_TipoCultura : System.Web.UI.Page
{
    internal string _nometela = "Tipo de Cultura";
    ...
    internal string ControlFocusOnInsert = "dsTipoCultura";
    // Update
    internal string DisableOnUpdateForm = "";
    internal string VanishOnUpdateForm = "";
    internal string ControlFocusOnUpdate = "dsTipoCultura";
    // Delete
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lib.VerificarAcessoBotao("TipoCultura", btIncluir);
            lib.VerificarAcessoBotao("TipoCultura", btEdit);
            lib.VerificarAcessoBotao("TipoCultura", btView);

            //lib.VerificarAcessoBotao("TipoCulturaHistorico", btHistorico);
        }
    ...
    internal void LoadData()
    {
        ...
        fv.DataSource = obj.Obter(Convert.ToInt64(Session["TipoCulturaGridViewSelected"]));
        fv.DataBind();
    }
    ...
    {
        if (Session["TipoCulturaGridViewSelected"] == null)
            Response.Redirect("~/Message.aspx?tp=exp&msg=", true);
        else
            if (Session["TipoCulturaGridViewSelected"].ToString() == "0")
            {
    ...
    protected void btHistorico_OnClick(object sender, EventArgs e)
    {
        ...
        {
            PrepareCall();
            Response.Redirect("~/_SFA/Cadastros/TipoCulturaHistorico/TipoCulturaHistorico.aspx");
        }
    }
    ...
    protected void PrepareCall()
    {
        ...
        Session["cdTipoCulturaSEQ"] = Session["TipoCulturaGridViewSelected"];
        Session["dsTipoCulturaHistorico"] = gv.SelectedRow.Cells[2].Text;
    }
}
