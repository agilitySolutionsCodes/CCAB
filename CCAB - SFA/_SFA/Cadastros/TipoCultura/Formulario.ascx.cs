...
public partial class _SFA_TipoCultura_Formulario : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CustomComboInit_Add("cdIndicadorStatusTipoCultura", "1", false); 
    ...
    protected void btAction_OnClick(object sender, EventArgs e)
    {
        ...
        Conv.ReflectObject<TipoCultura> ro = new Conv.ReflectObject<TipoCultura>();
    ...
    protected void ConfigCombo(object sender, EventArgs e)
    {
        if (FormView1.CurrentMode != FormViewMode.Insert)
        {
            ...
            try
            {
                d.SelectedValue = r[d.ID].ToString(); 
            }
            catch
            {
                d.SelectedValue = "0"; 
        ...
        else
        {
            ...
            try
            {
                if (CustomComboInit.Count > 0) 
                {
                    ...
                    d.SelectedValue = lic.FindByText(d.ID).Value; 
            }
            catch
            {
                d.SelectedValue = "0"; 
