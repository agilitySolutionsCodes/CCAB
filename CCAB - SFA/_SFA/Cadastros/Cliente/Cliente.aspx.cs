...
public partial class _SFA_Cliente_Cliente : System.Web.UI.Page
{
    internal string _nometela = "Cliente";
    ...
    // View
    internal string DisableOnViewForm = "dsLoginPessoa;cdIndicadorTipoAcessoPessoa;cdIndicadorPrimeiroAcessoPessoa;cdIndicadorSenhaBloqueadaPessoa;cdGrupoAcessoSEQ";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Session["ClienteGridViewSelected"] = "0";

            lib.VerificarAcessoBotao("Cliente", btEdit);
            lib.VerificarAcessoBotao("Cliente", btView);

            //lib.VerificarAcessoBotao("ClienteHistorico", btHistorico);
        }
    ...
    protected void ConfigForm(string _acao)
    {
        ...
        switch (_acao)
        {
            ...
            case "Edit":
                {
                    _titulo = "Alterar";
                    _actionCommandName = "AlterarCliente";
    ...
    internal void LoadData()
    {
        ...
        fv.DataSource = obj.ObterCliente(Convert.ToInt64(Session["ClienteGridViewSelected"]));
        fv.DataBind();
    }
    ...
    {
        if (Session["ClienteGridViewSelected"] == null)
            Response.Redirect("~/Message.aspx?tp=exp&msg=", true);
        else
            if (Session["ClienteGridViewSelected"].ToString() == "0")
            {
    ...
    protected void btHistorico_OnClick(object sender, EventArgs e)
    {
        if (checkRowID())
        {
            ...
            Session["cdPessoaSEQ"] = Session["ClienteGridViewSelected"];
            ...
            Response.Redirect("~/_SFA/Cadastros/ClienteHistorico/ClienteHistorico.aspx");
        }
    }
}
