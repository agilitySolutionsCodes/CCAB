...
public partial class _SFA_Cliente_Resultado : System.Web.UI.UserControl
{
    ...
    protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            Session["ClienteGridViewSelected"] = GridView1.SelectedDataKey.Value.ToString();
            Session["ClienteGridViewIndex"] = GridView1.SelectedIndex;
        }
        catch
        {
            Session["ClienteGridViewSelected"] = "0";
            Session["ClienteGridViewIndex"] = "0";
    ...
    {
        BindGridView();
        GridView1.SelectedIndex = Convert.ToInt16(Session["ClienteGridViewIndex"]);
        try
        {
            Session["ClienteGridViewSelected"] = GridView1.SelectedDataKey.Value.ToString();
        }
