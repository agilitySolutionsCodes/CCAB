...
public partial class _SFA_Vencimento_Resultado : System.Web.UI.UserControl
{
    ...
    protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["VencimentoGridViewIndex"] = GridView1.SelectedIndex;
        }
        catch
        {
            Session["VencimentoGridViewSelected"] = "0";
            Session["VencimentoGridViewIndex"] = "0";
