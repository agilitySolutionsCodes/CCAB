...
public partial class _SFA_Vencimento_Vencimento : System.Web.UI.Page
{
    internal string _nometela = "Cronograma da Safra - Vencimentos";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lib.VerificarAcessoBotao("Vencimento", btIncluir);
            lib.VerificarAcessoBotao("Vencimento", btEdit);
            lib.VerificarAcessoBotao("Vencimento", btView);
            lib.VerificarAcessoBotao("Vencimento", btDelete);
    ...
    protected void imageButtonPrecoPontualidade_Click(object sender, ImageClickEventArgs e)
    {
        if (checkRowID())
        {
            PrepareCall();
            Response.Redirect("~/_SFA/Cadastros/PrecoPontualidade/PrecoPontualidade.aspx");
        }
            ...
            case "View":
                {
                    ...
                    lib.DisableControls();
                    RadioButtonList rbl = (RadioButtonList)fv.FindControl("RadioButtonList1");
                    rbl.Enabled = false;
                    TextBox t = (TextBox)fv.FindControl("dtCronogramaSafraVencimento");
            ...
            case "Edit":
                {
                    ...
                    _actionOnClientClick = "return ConfirmacaoAlteracao('')";
            ...
            case "Delete":
                {
                    ...
                    _actionOnClientClick = "return Confirmacao('')";
    ...
    internal void LoadData()
    {
        ...
        fv.DataSource = obj.Obter(Convert.ToInt64(Session["VencimentoGridViewSelected"]));
        fv.DataBind();
    }
    ...
    {
        if (Session["VencimentoGridViewSelected"] == null)
            Response.Redirect("~/Message.aspx?tp=exp&msg=", true);
        else
            if (Session["VencimentoGridViewSelected"].ToString() == "0")
            {
    ...
    {
        Response.Redirect("~/_SFA/Cadastros/CronogramaSafra/CronogramaSafra.aspx?ta=ret");
    }
}
