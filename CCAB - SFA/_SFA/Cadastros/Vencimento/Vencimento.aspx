<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vencimento.aspx.cs" Inherits="_SFA_Vencimento_Vencimento" %>
<%@ Register TagPrefix="uc" TagName="DadosPai" Src="~/_SFA/Cadastros/Vencimento/DadosPai.ascx" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/Cadastros/Vencimento/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/Cadastros/Vencimento/Resultado.ascx" %>
<%@ Register TagPrefix="uc" TagName="Formulario" Src="~/_SFA/Cadastros/Vencimento/Formulario.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function ConfirmacaoAlteracao() {
            return confirm("A Tabela de Preço precisa ser atualizada. Deseja prosseguir?");
        }
                                ...
                                <tr>
                                    <td width="400" align="left">
                                        <asp:ImageButton runat="server" id="btVoltar" BackColor="Transparent" ImageAlign="Top" 
                                            ImageUrl="~/imgsCCAB/tbTitulo_btVoltar.gif" AlternateText=".: voltar" onclick="btVoltar_Click" 
                                             />&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <asp:ImageButton    ID="imageButtonPrincipioAtivo" ImageAlign="AbsMiddle" 
                                                            BackColor="Transparent" ImageUrl="~/imgsCCAB/tbTitulo_btPrecoPontualidade.gif" 
                                                            AlternateText=".: Regras de Preço / Pontualidade" runat="server" 
                                                            onclick="imageButtonPrecoPontualidade_Click" />
