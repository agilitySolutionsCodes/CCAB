<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LiberarPedidoCCAB.aspx.cs" Inherits="_SFA_LiberarPedidoCCAB_LiberarPedidoCCAB" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/PedidoVenda/LiberarPedidoCCAB/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/PedidoVenda/LiberarPedidoCCAB/Resultado.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tbCadastro_Mestra">
        ...
        <br />
        <asp:Button runat="server" ID="btLiberarPedido" CssClass="button" Text="liberar pedido CCAB" 
