...
public partial class _SFA_LiberarPedidoCCAB_LiberarPedidoCCAB_Resultado : System.Web.UI.UserControl
{
    ...
    public void BindGridView()
    {
        ...
        DataTable dt = obj.ObterListaPedidoVendaLiberacaoCCAB(_agente,
                                                             _safra,
                                                             _cliente,
                                                             _entrega,
                                                             _moeda,
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            PedidoVenda obj = new PedidoVenda();
            msg = obj.LiberaPedidoCCAB(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
