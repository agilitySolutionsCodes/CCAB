...
public partial class _SFA_LiberarPedidoMicrosiga_LiberarPedidoMicrosiga_Resultado : System.Web.UI.UserControl
{
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            PedidoVenda obj = new PedidoVenda();
            msg = obj.LiberaPedidoMicrosiga(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
