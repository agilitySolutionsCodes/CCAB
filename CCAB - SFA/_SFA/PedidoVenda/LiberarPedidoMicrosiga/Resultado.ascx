<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Resultado.ascx.cs" Inherits="_SFA_LiberarPedidoMicrosiga_LiberarPedidoMicrosiga_Resultado" %>
...
<script type="text/javascript">
    ...
    function Confirmacao() {
        ...
        if (_valor <= 0) {
            ...
            return confirm("Deseja realmente liberar (Microsiga)\no(s) registro(s) selecionado(s)?");
    }
