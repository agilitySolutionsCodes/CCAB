<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NovoPedido.aspx.cs" Inherits="_SFA_PedidoVenda_NovoPedido" %>
<%@ Register TagPrefix="uc" TagName="Passo1" Src="~/_SFA/PedidoVenda/NovoPedido/Passo1.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo2Header" Src="~/_SFA/PedidoVenda/NovoPedido/Passo2Header.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo2" Src="~/_SFA/PedidoVenda/NovoPedido/Passo2.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo3Header" Src="~/_SFA/PedidoVenda/NovoPedido/Passo3Header.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo3" Src="~/_SFA/PedidoVenda/NovoPedido/Passo3.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo4" Src="~/_SFA/PedidoVenda/NovoPedido/Passo4.ascx" %>
<%@ Register TagPrefix="uc" TagName="Passo5" Src="~/_SFA/PedidoVenda/NovoPedido/Passo5.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <script language="javascript" type="text/javascript">
            ...
            {
	            window.open("./../../Relatorios/PedidoVenda.aspx?cdPedidoVendaSEQ=" + pCdPedidoVendaSEQ, "TabelaPreco" ,"toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=700,height=500,left=100,top=50");
	            return true;
            }
        </script> 
                    ...
                    <asp:View ID="View6" runat="server">
                        ...
                        <div class="tbCadastro_Mestra">
                            <h2 style="color: #808080">
                                Pedido Nº <%= numPedido %> inserido com sucesso.
                            </h2>
                            <br /><br />
                            <asp:Button runat="server" ID="btNovoPedido" CssClass="button" Text="novo pedido" 
                                CausesValidation="false" OnCommand="btNovoPedido_OnClick" />&nbsp;&nbsp;
