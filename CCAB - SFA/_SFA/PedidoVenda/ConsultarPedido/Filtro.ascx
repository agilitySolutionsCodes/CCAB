<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Filtro.ascx.cs" Inherits="_SFA_PedidoVenda_ConsultarPedido_Filtro" %>
...
<div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbGenerica_01">
        <tr>
            ...
            <td align="right" rowspan="10" class="tbTd_cinzaEscura" style="padding-right: 20px;">
        ...
        <tr>
            ...
            <td class="tbTd_CinzaClara">
                ...
                <asp:DropDownList ID="cdStatus" runat="server" AutoPostBack="false"   
                    CssClass="campoTexto" DataValueField="vrDominioCodigoReferenciado" 
