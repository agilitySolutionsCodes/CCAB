<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Passo2.ascx.cs" Inherits="_SFA_PedidoVenda_AlterarPedido_Passo2" %>
...
<script type="text/javascript">
    ...
    function chkQuant() {
        ...
        if (cellValue > 0) {
            if (cellValue < fator || cellValue % fator != 0) {
                alert("Valor deve ser múltiplo da\nQuantidade da Embalagem (" + ConvertToString(fator, 4) + ")");
    ...
    function somar() {
        ...
        spread.GetCellByRowCol(row, spread.GetColCount() - 1).innerText = ConvertToString(totalValue, 4);
    }
