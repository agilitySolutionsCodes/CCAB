...
public partial class _SFA_PedidoVenda_AlterarPedido_Passo5 : System.Web.UI.UserControl
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        //Verifico o Perfil do Usuário
        Usuario loUsuario = (Usuario)Session["Usuario"];

        if (loUsuario.cdPerfilUsuario == 5) //Perfil CCAB
        {
            if (!"1,2,3,4".Contains(p1.cdStatus))
            {
                Button bt = (Button)Parent.FindControl("btPasso5Salvar");
                bt.Visible = false;
            }
        }
        else //Outros Perfís
