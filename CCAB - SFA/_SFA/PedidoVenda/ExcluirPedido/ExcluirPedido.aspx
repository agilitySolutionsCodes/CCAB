<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExcluirPedido.aspx.cs" Inherits="_SFA_ExcluirPedidoVenda_ExcluirPedidoVenda" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/PedidoVenda/ExcluirPedido/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/PedidoVenda/ExcluirPedido/Resultado.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tbCadastro_Mestra">
        <h2 style="color: #808080">
            Pedido(s) Excluido(s) com sucesso.<br />
        </h2>
        <br />
        <asp:Button runat="server" ID="btExcluirPedido" CssClass="button" Text="excluir pedido" 
