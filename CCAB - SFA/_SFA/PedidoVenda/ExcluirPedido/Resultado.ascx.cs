...
public partial class _SFA_PedidoVenda_ExcluirPedidoVenda_Resultado : System.Web.UI.UserControl
{
    ...
    public void BindGridView()
    {
        ...
        DataTable dt = obj.ObterListaPedidoVendaExclusao(_agente,
                                                         _safra,
                                                         _cliente,
                                                         _entrega,
                                                         _moeda,
    ...
    protected void btAction_Click(object sender, EventArgs e)
    {
        ...
        {
            PedidoVenda obj = new PedidoVenda();
            msg = obj.ExcluiPedidoVenda(Convert.ToInt64(Session["cdUsuario"]), sb.ToString());
        }
        else
