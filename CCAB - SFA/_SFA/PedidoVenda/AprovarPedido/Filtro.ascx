<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Filtro.ascx.cs" Inherits="_SFA_PedidoVenda_AprovarPedido_Filtro" %>
...
<div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbGenerica_01">
        <tr>
            ...
            <td align="right" rowspan="8" class="tbTd_cinzaEscura" style="padding-right: 20px;">
