<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AprovarPedido.aspx.cs" Inherits="_SFA_PedidoVenda_AprovarPedido" %>
<%@ Register TagPrefix="uc" TagName="Filtro" Src="~/_SFA/PedidoVenda/AprovarPedido/Filtro.ascx" %>
<%@ Register TagPrefix="uc" TagName="Resultado" Src="~/_SFA/PedidoVenda/AprovarPedido/Resultado.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tbCadastro_Mestra">
        <h2 style="color: #808080">
            Ação executada com sucesso.<br />
        </h2>
        <br />
        <asp:Button runat="server" ID="btAprovarPedido" CssClass="button" Text="Retornar" 
            CausesValidation="false" Width="150" OnClick="btAprovarPedido_Click" />
    </div>  
    <%} %>  
