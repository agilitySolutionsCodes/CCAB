<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Resultado.ascx.cs" Inherits="_SFA_PedidoVenda_AprovarPedido_Resultado" %>
...
<script type="text/javascript">
    ...
    function ExibirRelatorioAnalitico(pCdPedidoVendaSEQ, pCdAgenteComercialCooperativaPedidoVenda, pCdCronogramaSafraSEQ, pCdIndicadorStatusPedidoVenda, pCdIndicadorMoedaPedidoVenda, pCdClienteFaturamentoPedidoVenda, pCdClienteEntregaPedidoVenda, pCdPessoaOrigemFaturamento)
    {
    ...
    function Confirmacao() {
        ...
        if (_valor <= 0) {
            ...
            return confirm("Deseja realmente aprovar o(s) registro(s) selecionado(s)?");
    }

    function ConfirmacaoRejeitar() {
        ...
        if (_valor <= 0) {
            ...
            return confirm("Deseja realmente rejeitar o(s) registro(s) selecionado(s)?");
    }
...
<div style="text-align: right; margin-top: 15px;">
    <table>
        <tr>
            ...
            <td>
                <asp:Button runat="server" ID="btAction2" CssClass="button" ValidationGroup="Form"
                    Text="Rejeitar" CausesValidation="true" 
                    OnClientClick="return ConfirmacaoRejeitar()" 
                    OnClick="btAction2_Click" Visible="false" /> 
            </td>

        
            <td>
                <asp:Button runat="server" ID="btAction" CssClass="button" ValidationGroup="Form"
                    Text="Aprovar" CausesValidation="true" 
