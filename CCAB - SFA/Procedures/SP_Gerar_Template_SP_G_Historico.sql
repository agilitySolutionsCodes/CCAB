IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_Gerar_Template_SP_G_Historico]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_Gerar_Template_SP_G_Historico]
END
GO

CREATE PROCEDURE [dbo].[SP_Gerar_Template_SP_G_Historico]
...
print '/******************************************************************************'
print '**		File: SP_G_' + @NomeTabela + 'Historico.sql'
print '**		Name: SP_G_' + @NomeTabela + 'Historico'
print '**		Desc: Obtem uma lista de registros da tabela ' + @NomeTabela + 'Historico'
print '**'
...
print 'IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[dbo].[SP_G_' + @NomeTabela + 'Historico]''))'
print 'BEGIN'
print '	DROP PROCEDURE [dbo].[SP_G_' + @NomeTabela + 'Historico]'
print 'END'
print 'GO'

print ''

print 'CREATE PROCEDURE [dbo].[SP_G_' + @NomeTabela + 'Historico]'
