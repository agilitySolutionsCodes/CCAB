...
/******************************************************************************
**		File: SP_I_SolicitacaoEnvioEmail_AprovacaoPedidoCCAB.sql
**		Name: SP_I_SolicitacaoEnvioEmail_AprovacaoPedidoCCAB
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_I_SolicitacaoEnvioEmail_AprovacaoPedidoCCAB]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_AprovacaoPedidoCCAB]
END
GO

CREATE PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_AprovacaoPedidoCCAB]
...
declare
	...
	FROM
		dbo.TemplateEmail
	WHERE
		cdTemplateEmail				= 8 -- aprovação Pedido CCAB
