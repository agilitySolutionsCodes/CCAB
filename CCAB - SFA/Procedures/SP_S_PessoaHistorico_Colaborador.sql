...
/******************************************************************************
**		File: SP_S_PessoaHistorico_Colaborador.sql
**		Name: SP_S_PessoaHistorico_Colaborador
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_S_PessoaHistorico_Colaborador]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_S_PessoaHistorico_Colaborador]
END
GO
 
CREATE PROCEDURE [dbo].[SP_S_PessoaHistorico_Colaborador]
