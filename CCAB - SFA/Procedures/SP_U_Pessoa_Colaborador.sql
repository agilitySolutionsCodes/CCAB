...
/******************************************************************************
**		File: SP_U_Pessoa_Colaborador.sql
**		Name: SP_U_Pessoa_Colaborador
**		Desc: Altera um registro na tabela Pessoa - Colaborador
**
**		Auth: Convergence
**		Date: 18/03/2009
*******************************************************************************
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_U_Pessoa_Colaborador]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_U_Pessoa_Colaborador]
END
GO
 
CREATE PROCEDURE [dbo].[SP_U_Pessoa_Colaborador]
	 @cdPessoaSEQ	BIGINT
	,@nmPessoa						varchar(70)
	,@cdIndicadorTipoPerfilPessoa		int
	,@enEmailPrincipalPessoa			varchar(70)	= null
	,@cdEmpresaColaboradorPessoa	bigint
	,@cdIndicadorStatusPessoa			int
...
AS
	...
	UPDATE Pessoa SET
		...
		,cdEmpresaColaboradorPessoa = @cdEmpresaColaboradorPessoa
