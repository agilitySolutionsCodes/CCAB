...
/******************************************************************************
**		File: SP_I_SolicitacaoEnvioEmail_RejeitaPedidoCCAB.sql
**		Name: SP_I_SolicitacaoEnvioEmail_RejeitaPedidoCCAB
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_I_SolicitacaoEnvioEmail_RejeitaPedidoCCAB]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_RejeitaPedidoCCAB]
END
GO

CREATE PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_RejeitaPedidoCCAB]
...
declare
	...
	FROM
		dbo.TemplateEmail
	WHERE
		cdTemplateEmail				= 10 -- Reprovação Pedido CCAB
