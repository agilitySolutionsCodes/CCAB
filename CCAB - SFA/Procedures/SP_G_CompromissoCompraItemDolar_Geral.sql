/******************************************************************************
**		File: SP_G_CompromissoCompraItemDolar_Geral.sql
**		Name: SP_G_CompromissoCompraItemDolar_Geral
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_G_CompromissoCompraItemDolar_Geral]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_G_CompromissoCompraItemDolar_Geral]
END
GO
 

CREATE PROCEDURE [dbo].[SP_G_CompromissoCompraItemDolar_Geral]
...
AS
	...
	BEGIN
		...
		BEGIN
			...
			select
				@vrUnitarioMoedaCompromissoCompraItem = CCI.vrDolarPessoaTabelaPrecoProduto
			from
