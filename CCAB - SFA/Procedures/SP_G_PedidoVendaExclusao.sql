...
/******************************************************************************
**		File: SP_G_PedidoVendaExclusao.sql
**		Name: SP_G_PedidoVendaExclusao
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_G_PedidoVendaExclusao]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_G_PedidoVendaExclusao]
END
GO

CREATE PROCEDURE [dbo].[SP_G_PedidoVendaExclusao]
