...
/******************************************************************************
**		File: SP_S_Pessoa_Vendedor.sql
**		Name: SP_S_Pessoa_Vendedor
**		Desc: Obtem um registro da tabela Pessoa - Vendedor
**
**		Auth: Convergence
**		Date: 16/03/2009
*******************************************************************************
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_S_Pessoa_Vendedor]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_S_Pessoa_Vendedor]
END
GO
 
CREATE PROCEDURE [dbo].[SP_S_Pessoa_Vendedor]
	 @cdPessoaSEQ	BIGINT
