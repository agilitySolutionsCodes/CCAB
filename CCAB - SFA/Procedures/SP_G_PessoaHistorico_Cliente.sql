...
/******************************************************************************
**		File: SP_G_PessoaHistorico_Cliente.sql
**		Name: SP_G_PessoaHistorico_Cliente
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_G_PessoaHistorico_Cliente]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_G_PessoaHistorico_Cliente]
END
GO
 
CREATE PROCEDURE [dbo].[SP_G_PessoaHistorico_Cliente]
	 @cdPessoaSEQ	BIGINT
