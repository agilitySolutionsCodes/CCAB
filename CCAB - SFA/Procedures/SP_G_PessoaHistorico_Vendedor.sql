...
/******************************************************************************
**		File: SP_G_PessoaHistorico_Vendedor.sql
**		Name: SP_G_PessoaHistorico_Vendedor
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_G_PessoaHistorico_Vendedor]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_G_PessoaHistorico_Vendedor]
END
GO
 
CREATE PROCEDURE [dbo].[SP_G_PessoaHistorico_Vendedor]
	 @cdPessoaSEQ	BIGINT
