...
/******************************************************************************
**		File: SP_I_SolicitacaoEnvioEmail_AlteracaoPedido.sql
**		Name: SP_I_SolicitacaoEnvioEmail_AlteracaoPedido
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_I_SolicitacaoEnvioEmail_AlteracaoPedido]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_AlteracaoPedido]
END
GO

CREATE PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_AlteracaoPedido]
...
declare
	...
	FROM
		dbo.TemplateEmail
	WHERE
		cdTemplateEmail				= 5 --Alteração de Pedido
