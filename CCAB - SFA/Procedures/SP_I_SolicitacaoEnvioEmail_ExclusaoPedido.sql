...
/******************************************************************************
**		File: SP_I_SolicitacaoEnvioEmail_ExclusaoPedido.sql
**		Name: SP_I_SolicitacaoEnvioEmail_ExclusaoPedido
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_I_SolicitacaoEnvioEmail_ExclusaoPedido]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_ExclusaoPedido]
END
GO

CREATE PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_ExclusaoPedido]
...
declare
	...
	FROM
		dbo.TemplateEmail
	WHERE
		cdTemplateEmail				= 6 --Exclusao do Pedido
