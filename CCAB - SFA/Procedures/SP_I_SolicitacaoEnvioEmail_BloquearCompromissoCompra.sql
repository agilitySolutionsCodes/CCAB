...
/******************************************************************************
**		File: SP_I_SolicitacaoEnvioEmail_BloquearCompromissoCompra.sql
**		Name: SP_I_SolicitacaoEnvioEmail_BloquearCompromissoCompra
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_I_SolicitacaoEnvioEmail_BloquearCompromissoCompra]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_BloquearCompromissoCompra]
END
GO

CREATE PROCEDURE [dbo].[SP_I_SolicitacaoEnvioEmail_BloquearCompromissoCompra]
...
declare
	...
	FROM
		dbo.TemplateEmail
	WHERE
		cdTemplateEmail				= 4 --Bloqueio de Comprimisso
