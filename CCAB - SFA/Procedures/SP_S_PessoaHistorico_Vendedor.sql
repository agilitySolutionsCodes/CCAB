...
/******************************************************************************
**		File: SP_S_PessoaHistorico_Vendedor.sql
**		Name: SP_S_PessoaHistorico_Vendedor
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_S_PessoaHistorico_Vendedor]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_S_PessoaHistorico_Vendedor]
END
GO
 
CREATE PROCEDURE [dbo].[SP_S_PessoaHistorico_Vendedor]
