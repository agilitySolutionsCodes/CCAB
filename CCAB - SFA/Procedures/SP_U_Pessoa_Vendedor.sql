...
/******************************************************************************
**		File: SP_U_Pessoa_Vendedor.sql
**		Name: SP_U_Pessoa_Vendedor
**		Desc: Altera um registro na tabela Pessoa - Vendedor
**
**		Auth: Convergence
**		Date: 17/03/2009
*******************************************************************************
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_U_Pessoa_Vendedor]'))
BEGIN
	DROP PROCEDURE [dbo].[SP_U_Pessoa_Vendedor]
END
GO
 
CREATE PROCEDURE [dbo].[SP_U_Pessoa_Vendedor]
	 @cdPessoaSEQ	BIGINT
	...
	,@enEmailPrincipalPessoa	varchar(70)
